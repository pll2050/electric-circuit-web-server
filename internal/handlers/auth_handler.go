...
// HandleVerifyToken handles token verification requests
func (h *AuthHandler) HandleVerifyToken(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.authController.VerifyToken(r.Context(), &req)
	if err != nil {
...
func (h *AuthHandler) HandleCreateUser(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.authController.CreateUser(r.Context(), &req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *AuthHandler) HandleGetUser(w http.ResponseWriter, r *http.Request) {
	...
	req := &controllers.AuthRequest{UID: uid}
	resp, err := h.authController.GetUser(r.Context(), req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *AuthHandler) HandleUpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.authController.UpdateUser(r.Context(), &req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *AuthHandler) HandleDeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	req := &controllers.AuthRequest{UID: uid}
	resp, err := h.authController.DeleteUser(r.Context(), req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
// HandleSetCustomClaims handles custom claims setting requests
func (h *AuthHandler) HandleSetCustomClaims(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
		return
	}
	...
	resp, err := h.authController.SetCustomClaims(r.Context(), &req)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (h *AuthHandler) HandleListUsers(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.authController.ListUsers(r.Context())
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
