...
public interface IAuthService
{
    ...
    Task<UserRecord> UpdateFirebaseUserAsync(string uid, string? email = null, string? displayName = null, string? photoUrl = null, string? password = null, string? phoneNumber = null);
